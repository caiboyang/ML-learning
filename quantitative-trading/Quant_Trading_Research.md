...
【来源事实】Jegadeesh & Titman (1993, *Journal of Finance*)：按过去 1–4 个季度收益对个股排序，做多赢家组合、做空输家组合，**月均收益约 1.5%**。这是对弱式有效市场假说的直接反例。
...
for t in rebalance_dates:
    ...
    score = R.loc[t-12 : t-1, universe].sum()         # 跳过最近 1 个月：规避短期反转
...
| # | 步骤 | 不做的后果 |
|---|---|---|
| 1 | **跳过最近 1 个月** | 短期反转与中期动量方向相反，会互相抵消，可能得出「动量无效」的错误结论 |
...
| 年 | 文献 | 贡献 |
|---|---|---|
| 1993 | **Jegadeesh & Titman, "Returns to Buying Winners and Selling Losers", *JF*** | 截面动量；月均约 1.5% |
...
1. 所有带具体数值的业绩与统计结论（1.5% 月收益、Sharpe 1.44 / 0.90 / 1.10、65% / 82%、−58% / −26%、316 / 452 / 97 / 58 个、45 次尝试、t > 3.0 / 2.78 / 1.96）均标注了具体来源，且已与来源核对。
